...
const properties = [
  ...
  },
  {
    ...
    price: 'R$ 7.800.000',
    image: 'https://images.unsplash.com/photo-1560185007-c5ca9d2c0862?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
    beds: 3,
    baths: 4,
    area: '320 m²',
  },
    ...
    <section className="py-20 bg-white">
      <div className="luxury-container">
        ...
        <p className="text-center text-luxury-mediumGray mb-12 max-w-2xl mx-auto">
          Conheça nossa seleção exclusiva de propriedades premium nas melhores localizações
        </p>
              ...
              <div className="relative overflow-hidden h-80">
                ...
                <div className="property-card-overlay group-hover:opacity-100">
                  <div className="bg-black bg-opacity-50 p-4 -mx-6 -mb-6">
                    <h3 className="text-white text-xl font-playfair mb-1">{property.title}</h3>
                    <div className="flex items-center text-white/80 text-sm mb-2">
                      <MapPin className="h-4 w-4 mr-1" />
                      <span>{property.location}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-luxury-gold font-semibold">{property.price}</span>
